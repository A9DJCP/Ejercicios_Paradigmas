...
public class Principal {
	...
	public static void main(String[] args) {
		/*TIRA ERROR --> java.lang.ClassCastException al agregar un producto por el comparator*/
		...
		for (Producto producto : carrito.keySet()) {
			System.out.println("Producto: " + producto.nombreProducto + " // ID: " + producto.idProducto + " // Cant: "
